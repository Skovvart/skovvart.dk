<script lang="ts">
	...
	export let url = 'about/';
	export let title = 'Hi man';
	export let description = 'Do you ever even feel as to know how why it be like?';
	export let callToAction = 'Click my button, baby!';
	export let pixumImageId = 149;
</script>

<div class="card">
	<a href={url} aria-label={callToAction}>
