...
<header class="header">
  ...
  <nav class="header-navigation">
    <!-- <a aria-current={segment === 'blog' ? 'page' : undefined} class="header-navigation__item" href="blog/" rel="prefetch">Blog</a> -->
    <a aria-current={segment === 'about' ? 'page' : undefined} class="header-navigation__item" href="about/" rel="prefetch">About</a>
    <a aria-current={segment === 'services' ? 'page' : undefined} class="header-navigation__item" href="services/" rel="prefetch">Services</a>
    <a class="header-navigation__item" href="https://tv.skovvart.dk" rel="prefetch">TV-guide</a>
  </nav>
</header>
